    ...
    <>
      ...
      <div className="mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
        <div className="text-center text-gray-800">
          <div className="backdrop-blur-md block rounded-lg shadow-lg px-6 py-12 banner-card m-0">
            <h1 className="text-3xl md:text-xl xl:text-6xl font-bold tracking-tight mb-4">
              Track Your Calories and Reach Your Goals <br />
            </h1>
            <h2>
              <span className="font text-xl tracking-tight font-bold">
            ...
            <Link
              to="/signup"
              className="inline-block px-7 py-3  mt-5 mb-2 md:mb-0 mr-0 md:mr-2 bg-blue-600 text-white font-medium text-sm leading-snug uppercase rounded shadow-md lg:inline-block text-white bg-[#FF9119] hover:bg-[#FF9119]/80 focus:ring-4 focus:outline-none focus:ring-[#FF9119]/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:hover:bg-[#FF9119]/80 dark:focus:ring-[#FF9119]/40 mr-2 mb-2 active:shadow-lg transition duration-150 ease-in-out"
            ...
            <Link
              to="/about"
              className="inline-block px-7 py-3 text-black font-medium text-sm leading-snug bg-transparent le uppercase rounded hover:text-blue-700 hover:bg-gray-100 focus:bg-gray-100 focus:outline-none focus:ring-0 active:bg-gray-200 transition duration-150 ease-in-out"
              data-mdb-ripple="true"
              data-mdb-ripple-color="light"
              href="#!"
              role="button"
